...
* Redis insight will be available on localhost:8001, JS SPA at localhost:8002

# RedisxDEVHackathon tiny btc onchain analysis

Project that queries BTC chain and discover interactions between wallets, trending wallets. The project aims to  
